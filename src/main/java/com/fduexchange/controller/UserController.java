...
import com.fduexchange.token.TokenProccessor;
import com.fduexchange.tool.SaveSession;
...
//        userCollection.setSid(sid);
    ...
    public String insertGoods(@RequestParam String name, @RequestParam int level,
        ...
        if (action == 1) {
            ...
            String random;
            String path = "/usr/local/tomcat/webapps/", save = "";
            random = "images/" + StringUtils.getInstance().getRandomChar() + System.currentTimeMillis() + ".jpg";
            StringBuilder thumbnails = new StringBuilder();
            thumbnails.append(path);
            thumbnails.append("images/thumbnails/");
            StringBuilder newSb = new StringBuilder();
            newSb.append(StringUtils.getInstance().getRandomChar()).append(System.currentTimeMillis());
            thumbnails.append(newSb);
            ...
            save = "/images/thumbnails/" + newSb.toString();
